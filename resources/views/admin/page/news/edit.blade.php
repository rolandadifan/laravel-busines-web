...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 mb-5">{{$news->name}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <form action="{{ route('news.update', $news->id) }}" method="POST" enctype='multipart/form-data'>
            ...
            <div class="form-group">
                ...
                <textarea name="description" name="description" id="news-create" class="form-control" id="description" cols="30" rows="10" required>{!! $news->description !!}</textarea>
            </div>
